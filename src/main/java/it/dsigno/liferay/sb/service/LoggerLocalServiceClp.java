 ...
 * @generated
 */
public class LoggerLocalServiceClp implements LoggerLocalService {
    ...
    public LoggerLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public it.dsigno.liferay.sb.model.Logger addLogger(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(logger) });
        } catch (Throwable t) {
        ...
        return (it.dsigno.liferay.sb.model.Logger) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public it.dsigno.liferay.sb.model.Logger createLogger(long loggerId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { loggerId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public it.dsigno.liferay.sb.model.Logger deleteLogger(long loggerId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { loggerId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public it.dsigno.liferay.sb.model.Logger fetchLogger(long loggerId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { loggerId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public it.dsigno.liferay.sb.model.Logger getLogger(long loggerId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { loggerId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<it.dsigno.liferay.sb.model.Logger> getLoggers(
        ...
        return (java.util.List<it.dsigno.liferay.sb.model.Logger>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public it.dsigno.liferay.sb.model.Logger addLogMessage(long userId,
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    ClpSerializer.translateInput(logMessage)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
